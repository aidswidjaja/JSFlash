...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1620771071);
user_pref("app.update.lastUpdateTime.background-update-timer", 1624769276);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1624769155);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1624770117);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1624769396);
...
user_pref("browser.history.last_page_visited", "http://heyo.adrian.id.au/JSFlash/");
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1624764778629");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1624786378629");
user_pref("browser.search.countryCode", "AU");
user_pref("browser.search.region", "AU");
user_pref("browser.startup.homepage", "https://aidswidjaja.github.io/JSFlash");
...
user_pref("devtools.toolbox.footer.height", 774);
...
user_pref("general.useragent.override", "     Mozilla/5.0 (Macintosh; Intel Mac OS X 11.4; rv:89.0) Gecko/20100101 Firefox/89.0");
...
user_pref("services.blocklist.addons.checked", 1624768249);
user_pref("services.blocklist.clock_skew_seconds", 906);
user_pref("services.blocklist.gfx.checked", 1624768249);
user_pref("services.blocklist.last_update_seconds", 1624768249);
user_pref("services.blocklist.pinning.checked", 1624768249);
user_pref("services.blocklist.plugins.checked", 1624768249);
